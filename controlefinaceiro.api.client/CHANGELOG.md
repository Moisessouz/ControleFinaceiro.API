...
- Crie um projeto react com create-vite: `npm init --yes vite@latest controlefinaceiro.api.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Criar o arquivo de projeto (`controlefinaceiro.api.client.esproj`).
